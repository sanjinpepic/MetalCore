    ...
    return (
        <div className="space-y-8">
            <div className="flex items-center justify-between">
                <div>
                    <p className="text-[10px] text-stone-500 uppercase font-mono font-medium tracking-[0.2em] mt-1">Foundry-Spec Heat Treatment Guide</p>
                </div>
                <div className="flex items-center gap-2">
                    <div className="w-2 h-2 rounded-full bg-accent animate-ember-pulse" />
                    <span className="text-[10px] font-mono font-medium text-accent uppercase tracking-[0.2em]">Hardening Phase</span>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="p-6 bg-black/40 rounded-3xl border border-white/5 space-y-6">
                    <div>
                        <div className="text-[10px] font-mono font-medium text-stone-500 uppercase tracking-[0.2em] mb-3">Quench Medium</div>
                    ...
                    <div>
                        <div className="text-[10px] font-mono font-medium text-stone-500 uppercase tracking-[0.2em] mb-3">Austenitizing Temp</div>
                        <div className="flex items-center gap-4">
                    ...
                    <div className="pt-4 border-t border-white/5">
                        <div className="flex items-center gap-3">
                            ...
                            <span className="text-[10px] font-mono font-medium text-stone-400 uppercase tracking-[0.2em]">Cryogenic Phase: <b>{data.cryo}</b></span>
                        </div>
                    </div>
                </div>
