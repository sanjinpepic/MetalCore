                ...
                <div className="flex flex-col md:flex-row items-start md:items-end gap-8 mt-8" ref={editRef}>
                    <div className="w-24 h-24 md:w-32 md:h-32 rounded-3xl bg-black/50 border-4 border-white/5 shadow-plate flex items-center justify-center overflow-hidden shrink-0 backdrop-blur-md">
                        {user.avatar ? (
                            ...
                            <div className="text-4xl md:text-5xl font-display text-accent uppercase">
                                {user.name.charAt(0)}
                            </div>
                        )}
                    </div>
                        ...
                        {isEditing ? (
                            <div className="space-y-4 max-w-lg">
                                <input
                                    ...
                                    className="bg-white/5 border border-accent/30 rounded-xl px-4 py-3 text-white font-display text-3xl md:text-4xl w-full focus:outline-none focus:border-accent uppercase"
                                />
                                <textarea
                                    value={editForm.bio}
