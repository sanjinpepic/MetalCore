...
const ProducerMap = ({ producers }) => {
    ...
    return (
        <div className="relative w-full bg-[#0B0A08] rounded-3xl border border-white/5 overflow-hidden p-6 md:p-10 shadow-plate-lg">
            {/* Header section */}
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-12 gap-4 relative z-10">
                <div>
                    <h3 className="text-xl md:text-2xl font-display text-white uppercase tracking-tight">Global Production Hubs</h3>
                    <p className="text-[10px] text-accent font-mono font-medium mt-1 uppercase tracking-[0.3em]">Precision Metallurgy Network</p>
                </div>
            </div>
