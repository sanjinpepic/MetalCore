                        ...
                        {groupedGlossary ? (
                            <div className="space-y-12">
                                {GLOSSARY_CATEGORIES.filter(c => c.id !== 'ALL').map(cat => {
                                    ...
                                    return (
                                        <section key={cat.id}>
                                            <div className="sticky top-[9.75rem] md:top-[4.5rem] z-20 -mx-4 px-4 md:-mx-12 md:px-12 py-3 mb-3 bg-[rgba(10,10,12,0.65)] backdrop-blur-xl border-y border-white/[0.06]">
