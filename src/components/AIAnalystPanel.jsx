...
const AIAnalystPanel = ({ aiOpen, setAiOpen, aiChat, isAiLoading, aiQuery, setAiQuery, askAi }) => {
    return (
        <div className={`fixed top-0 right-0 h-full w-full md:w-[400px] glass-panel border-l border-white/10 z-[110] transition-transform duration-500 ease-out-expo ${aiOpen ? 'translate-x-0' : 'translate-x-full'}`}>
            <div className="flex flex-col h-full bg-[#12100D]/95 backdrop-blur-3xl">
