    ...
    return (
        ...
        >
            <div className="p-6 md:p-8 pb-4 flex items-center justify-between shrink-0">
                ...
                <button onClick={() => setShowSettings(true)} className="p-2 rounded-xl bg-white/5 hover:bg-white/10 text-slate-500 hover:text-accent transition-all border border-white/5 flex items-center justify-center w-10 h-10 md:w-auto md:h-auto">
