    ...
    return (
        <div className="flex flex-col flex-1 min-w-0 h-screen overflow-y-auto custom-scrollbar bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] from-slate-900 via-slate-950 to-black">
            ...
            <div className="p-6 md:p-16 pt-24 md:pt-24 space-y-4 md:space-y-6 max-w-5xl">
                ...
                <div className="flex flex-col sm:flex-row gap-4 pt-4">
                    <button
                        ...
                        className="px-6 md:px-8 py-3 md:py-4 bg-white text-black rounded-xl font-bold hover:bg-slate-200 transition-all flex items-center justify-center gap-2 group text-sm md:text-base"
                    >
                        Browse Library
                    ...
                    <button
                        ...
                        className="px-6 md:px-8 py-3 md:py-4 bg-white/5 text-white border border-white/10 rounded-xl font-bold hover:bg-white/10 transition-all text-sm md:text-base"
                    >
                        View Matrix
                    </button>
                </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-4 px-6 md:px-16 mb-12 md:mb-16 max-w-6xl">
                {stats.map((stat, i) => (
                    <div key={i} className="glass-panel p-4 md:p-6 rounded-2xl border-white/5">
                ...
                <div className="glass-panel p-4 md:p-6 rounded-2xl border-white/5 bg-gradient-to-br from-accent/20 to-transparent border-accent/20">
                    <div className="text-2xl md:text-3xl font-black text-accent mb-1 font-display">2.0</div>
                    <div className="text-[8px] md:text-[10px] font-bold text-accent/80 uppercase tracking-widest">Version</div>
                </div>
            </div>
            ...
            {featuredSteel && (
                <div className="px-6 md:px-16 pb-16">
                    ...
                    <div className="glass-panel p-6 md:p-12 rounded-[2rem] md:rounded-[2.5rem] border-white/5 flex flex-col lg:flex-row gap-8 md:gap-12 group hover:border-white/10 transition-all relative overflow-hidden">
                        <div className="lg:w-1/2 relative z-10">
                            ...
                            <h2 className="text-3xl md:text-5xl font-black text-white italic mb-4 md:mb-6">{featuredSteel.name}</h2>
                            <p className="text-slate-400 text-sm md:text-lg mb-6 md:mb-8 leading-relaxed italic">"{featuredSteel.desc}"</p>
                        ...
                        <div className="lg:w-1/2 grid grid-cols-2 gap-3 md:gap-4 relative z-10">
                            {['edge', 'toughness', 'corrosion', 'sharpen'].map(metric => (
                                <div key={metric} className="bg-black/40 rounded-xl md:rounded-2xl p-3 md:p-4 border border-white/5">
                                    ...
                                    <div className="text-right text-[10px] md:text-xs font-mono font-bold text-white mt-1">{featuredSteel[metric]}/10</div>
                                </div>
                            ))}
                        </div>
