...
const PerformanceMatrix = ({ steels, setDetailSteel, activeProducer, setActiveProducer, producers }) => {
    ...
    return (
        <div className="flex flex-col flex-1 min-w-0 h-screen overflow-y-auto bg-black custom-scrollbar">
            ...
            <div className="flex-1 px-4 md:px-12 pb-6">
                <div className="h-[500px] md:h-full glass-panel rounded-2xl md:rounded-[2.5rem] p-2 md:p-10 relative overflow-hidden mb-6 md:mb-10">
                    {/* Quadrant Labels */}
            ...
            <div className="sticky bottom-0 z-20 px-4 md:px-12 py-4 bg-black/80 backdrop-blur-md border-t border-white/5 md:border-none md:bg-transparent md:backdrop-blur-none shrink-0 overflow-x-auto no-scrollbar max-w-full">
