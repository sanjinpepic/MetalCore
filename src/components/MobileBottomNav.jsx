                ...
                <div className="flex items-center justify-around py-2">
                    {navItems.map((item) => (
                        <button
                            ...
                            className={`flex flex-col items-center gap-1 px-4 py-2 rounded-xl transition-all ${view === item.id
                ...
                >
                    <div className="grid grid-cols-3 gap-2 pt-2 pb-4 border-t border-white/5">
                        ...
                        <button
                            ...
                            className="flex flex-col items-center gap-2 p-3 rounded-xl bg-gradient-to-br from-indigo-500/20 to-indigo-500/10 border border-indigo-500/30 text-indigo-400 hover:from-indigo-500/30 hover:to-indigo-500/20"
                        >
