            ...
            <div className="p-6 md:p-12 pb-32 space-y-10 md:space-y-16">
                {Object.entries(groupedSteels).map(([producer, steels]) => (
                    <section key={producer}>
                        <div className="sticky top-[4.25rem] md:top-[4.5rem] z-20 -mx-6 px-6 md:-mx-12 md:px-12 py-3 mb-4 md:mb-6 bg-black/80 backdrop-blur-xl border-b border-white/5">
